...
- **Lifecycles differ.** The program is continuous; engagements are
  annual. Next year is a new repo (`push2c init evidence-2027-soc2
...
```
push2c evidence coverage --dir ../evidence-2026-soc2 [--engagement 2026-soc2] [--json] [--fail-on-missing]
```
